...
export default function ProjectsSection({ projects }: ProjectsSectionProps) {
  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.01)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.01)_1px,transparent_1px)] bg-[size:30px_30px] sm:bg-[size:50px_50px] opacity-50 sm:opacity-100"></div>
