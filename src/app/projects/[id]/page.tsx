...
import { Share2, ExternalLink, Copy, Check, ScrollText, ArrowDown, Sparkles, Code2, Rocket, Star, Github, Play, Link } from 'lucide-react';
...
>
  ...
  <div className="space-y-4">
    <p className="text-sm text-white/90 leading-relaxed">
      Browse through my complete portfolio of projects and discover more innovative solutions.
    </p>
