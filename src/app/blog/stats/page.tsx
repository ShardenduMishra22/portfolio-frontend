...
<div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
  <Card className="bg-card border-border hover:bg-accent/5 hover:border-primary/20 transition-all group">
    ...
    <CardContent className="pt-0">
      <div className="text-xl font-bold text-foreground mb-1">{formatNumber(calculatedStats.totalPosts)}</div>
  ...
  <Card className="bg-card border-border hover:bg-accent/5 hover:border-secondary/20 transition-all group">
    ...
    <CardContent className="pt-0">
      <div className="text-xl font-bold text-foreground mb-1">{formatNumber(calculatedStats.totalViews)}</div>
  ...
  <Card className="bg-card border-border hover:bg-accent/5 hover:border-destructive/20 transition-all group">
    ...
    <CardContent className="pt-0">
      <div className="text-xl font-bold text-foreground mb-1">{formatNumber(calculatedStats.totalLikes)}</div>
  ...
  <Card className="bg-card border-border hover:bg-accent/5 hover:border-accent/40 transition-all group">
    ...
    <CardContent className="pt-0">
      <div className="text-xl font-bold text-foreground mb-1">{formatNumber(calculatedStats.totalComments)}</div>
    ...
    <CardContent className="p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg font-bold text-foreground">{formatNumber(calculatedStats.averageViewsPerPost)}</p>
        </div>
    ...
    <CardContent className="p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg font-bold text-foreground">{formatNumber(calculatedStats.averageLikesPerPost)}</p>
        </div>
    ...
    <CardContent className="p-4">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-lg font-bold text-foreground">{formatNumber(calculatedStats.averageCommentsPerPost)}</p>
        </div>
        ...
        <div className="flex items-center space-x-4 flex-shrink-0">
          <div className="text-center">
            <div className="text-lg font-bold text-secondary mb-1">
              {formatNumber(Array.isArray(calculatedStats.topPerformingPost.views) ? calculatedStats.topPerformingPost.views.length : (calculatedStats.topPerformingPost.views || 0))}
            </div>
          ...
          <div className="space-y-3">
            {Object.entries(calculatedStats.postsByAuthor)
              ...
              .map(([authorName, authorStats]) => (
                <div key={authorName} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
                  <div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3 text-xs text-foreground">
                <div className="flex items-center space-x-1">
                  <Eye className="w-3 h-3" />
                  <span>{formatNumber(Array.isArray(blog.views) ? blog.views.length : (blog.views || 0))}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <Heart className="w-3 h-3" />
                  <span>{formatNumber(Array.isArray(blog.likes) ? blog.likes.length : (blog.likes || 0))}</span>
                </div>
                <div className="flex items-center space-x-1">
                  <MessageCircle className="w-3 h-3" />
                  <span>{formatNumber(Array.isArray(blog.comments) ? blog.comments.length : (blog.comments || 0))}</span>
                </div>
              </div>
      ...
      <CardContent className="pt-0">
        <div className="space-y-3">
          {Object.entries(calculatedStats.postsByAuthor)
            .sort(([, a], [, b]) => b.totalViews - a.totalViews)
            .map(([authorName, authorStats]) => (
              <div key={authorName} className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-4">
                  <div className="text-center">
                    <div className="text-sm font-bold text-secondary">{formatNumber(authorStats.totalViews)}</div>
                    <div className="text-xs text-foreground">Views</div>
                  </div>
                  <div className="text-center">
                    <div className="text-sm font-bold text-destructive">{formatNumber(authorStats.totalLikes)}</div>
                    <div className="text-xs text-foreground">Likes</div>
                  </div>
                  <div className="text-center">
                    <div className="text-sm font-bold text-primary">{formatNumber(Math.round(authorStats.totalViews / authorStats.count))}</div>
      ...
      <CardContent className="pt-0">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {Object.entries(calculatedStats.postsByTag)
            .sort(([, a], [, b]) => b - a)
            .map(([tag, count]) => (
              <div key={tag} className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
